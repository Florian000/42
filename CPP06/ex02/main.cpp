...
int main() {
    ...
    // Test 2: Specific object of type A
    ...
    // Test 3: Specific object of type B
    ...
    // Test 4: Specific object of type C
    ...
    // Test 5: Reverse cases (invalid casts)
    std::cout << RED << "Test 5: Reverse cases (invalid casts)" << RESET << std::endl;
    ...
    // Test 6: A to B or B to A or to C
